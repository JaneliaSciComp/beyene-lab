...
path = '/Volumes/CB SSD/2023/07.07.2023/0616Dish#3/FOV4/ROI-1/TDT-MAP2-DFF/TDT-MAP2-DFF.tif';    
...
print('-painters','-depsc2',"imagesFromChandima/boutons")
...
print('-painters','-depsc2',"imagesFromChandima/hotspot-clustering")
...
for wholeOrBouton = ["TDT {\Delta}F (Normalized)","Bouton {\Delta}F (Normalized)"]
    ...
    print('-painters','-depsc2',"imagesFromChandima/"+outputName)
end
...
xlabel("{\Delta}F")
ylabel("Probability")
print('-painters','-depsc2',"imagesFromChandima/combined")
pause(1)
...
print('-painters','-depsc2',"imagesFromChandima/combined-errorbars")
