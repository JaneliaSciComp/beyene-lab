...
for i=1:numTrials
    ...
    print(gcf, '-dtiff', ['tifs/' prefix 'RandomShifts_TDT_Intensity_vs_Distance.tiff']);
    ...
    legend('','DAPI','','DRD1')
    print(gcf, '-dtiff', ['tifs/' prefix 'RandomShifts_Intensity_vs_TDT_Distance.tiff']);
    ...
    legend('','DAPI','','DRD1')
    print(gcf, '-dtiff', ['tifs/' prefix 'RandomShifts_Percent_Segmented_vs_TDT_Distance.tiff']);
